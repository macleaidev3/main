...
from ml_module.pipeline_126_to_113.predict_temp import TotalTemperaturePredictor
from ml_module.pipeline_126_to_113.predict_pressure import TotalPressurePredictor
from ml_module.pipeline_126_to_113.predict_wall_shear import WallShearPredictor
from ml_module.pipeline_126_to_113.predict_cr import CorrosionRatePredictor


from src.ml_pipelines.ICE126_ICV113.input_df_builder import PredictionInputBuilder
from src.utils.core_utility_functions import sigfig, format_date_long
class CRPredictionICE126TO113():
    ...
    def __init__(self, month: str, year: str, yesterday_date: str):
        ...
        self.year = year
        self.month = month
        self.table_name = f"{year}_126_to_113_cr"
