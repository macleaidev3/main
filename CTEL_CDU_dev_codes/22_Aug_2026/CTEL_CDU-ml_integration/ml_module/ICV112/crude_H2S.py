...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/crude_h2s/xgboost_crudeH2S_model.pkl"
)

PREPROCESSED_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/crude_h2s/preprocessed_data.pkl"
)

R2_SCALER_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/crude_h2s/r2_scaler.pkl"
)


class CrudeH2SPredictor:

    def __init__(self):

        self._target_column = "crude-p-h2s"
