...
training, predicts H2S, and returns the prediction without modifying
the input DataFrame.
"""
...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV113/h2s.joblib"
)
...
class H2SPredictor:
    ...
    def _validate_features(self, df: pd.DataFrame) -> None:
        ...
        if missing:
            raise ValueError(
                "Missing input features for H2S prediction: "
                f"{missing}"
            )