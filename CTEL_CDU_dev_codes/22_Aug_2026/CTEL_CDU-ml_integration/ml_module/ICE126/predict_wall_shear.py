...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICE126/wall_shear.pkl"
)


class WallShearPredictor:
    """
    Wall Shear prediction model.
    """
