        ...
        try:
            ...
            for i, year in enumerate(year_range):
                ...
                for month in month_short_names:
                    ...
                    #DB_MANAGER.drop_table(self.target_db, table_name=blend_properties_table) ##me
                ...
                for probe_id in probes_id_list:
                    for month in month_short_names:
                        ...
                        DB_MANAGER.create_table(self.target_db, table_name=contributor_table, columns=contributor_db_columns)

                        if DB_MANAGER.row_count(self.target_db, table_name=contributor_table) == 0:
                        ...
                        DB_MANAGER.create_table(self.target_db, table_name=thickness_table, columns=thickness_db_columns)
                        # DB_MANAGER.drop_table(self.target_db, table_name=thickness_table)

                        if DB_MANAGER.row_count(self.target_db, table_name=thickness_table) == 0:
