...
# from src.visual_script.ice126.visual_2d import ICE126Visual2d
# from src.visual_script.ice126.visual_3d import ICE126Visual3d
...
class CreateICE126Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/ice126/126.xlsx")
            new_widget = widget_class(equipment_name="126")
