...
# from src.visual_script.ice162.visual_3d import ICE162Visual3d
...
class CreateICE162Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/ice162/162.xlsx")
            new_widget = widget_class(equipment_name="162")
