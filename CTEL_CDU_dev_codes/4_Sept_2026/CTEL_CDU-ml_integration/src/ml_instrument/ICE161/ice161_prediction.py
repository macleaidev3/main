...
from ml_module.ICE161.predict_wall_shear import WallShearPredictor
from ml_module.ICE161.predict_total_temp import TotalTemperaturePredictor
from ml_module.ICE161.predict_total_pressure import TotalPressurePredictor
from ml_module.ICE161.predict_cr_rate import CorrosionRatePredictor



from src.ml_instrument.ICE161.input_df_builder import PredictionInputBuilder
from src.utils.core_utility_functions import sigfig, format_date_long
class CRPredictionICE161():
    ...
    def __init__(self, month: str, year: str, yesterday_date: str):
        ...
        self.year = year
        self.month = month
        self.table_name = f"{year}_161_cr"
    ...
    def set_up(self) -> None:
        ...
        if input_df.isna().any().any():
            ...
            input_df["WallShear[Pa]"] = predicted_wall_shear
