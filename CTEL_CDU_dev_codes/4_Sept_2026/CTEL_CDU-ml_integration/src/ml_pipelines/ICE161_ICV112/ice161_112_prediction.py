...
from ml_module.pipeline_161_to_112.predict_temp import TotalTemperaturePredictor
from ml_module.pipeline_161_to_112.predict_pressure import TotalPressurePredictor
from ml_module.pipeline_161_to_112.predict_wall_shear import WallShearPredictor
from ml_module.pipeline_161_to_112.predict_cr import CorrosionRatePredictor


from src.ml_pipelines.ICE161_ICV112.input_df_builder import PredictionInputBuilder
from src.utils.core_utility_functions import sigfig, format_date_long
class CRPredictionICE161TO112():
    ...
    def __init__(self, month: str, year: str, yesterday_date: str):
        ...
        self.year = year
        self.month = month
        self.table_name = f"{year}_161_to_112_cr"
