...
class FrozenTable(QtWidgets.QWidget):
    ...
    def _create_views(self):
        ...
        self._main_view.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.ResizeToContents)
        ...
        self._frozen_view.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Fixed)
...
if __name__ == "__main__":
    ...
    columns = ["Date", "Status", "Temperature degC", "Density", "API", "Sulphur", "Thickness"]
    frozen = 1
    ...
    table = FrozenTable(columns, data=rows, frozen_columns=frozen, min_column_width=110, max_column_width=320)
