        ...
        for column in required_inputs:
            ...
            if not is_valid_number(stored_value):
                ...
                raise RuntimeError(
                    ...
                    f"Table={self.contributor_table}, "
                    f"Column={column}, "
