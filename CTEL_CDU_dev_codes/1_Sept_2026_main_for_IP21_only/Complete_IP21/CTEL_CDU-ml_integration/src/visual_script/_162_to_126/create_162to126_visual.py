...
# from src.visual_script._162_to_126.visual_3d import ICE162to126Visual3d
...
class Create162to126Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/_162_to_126/162_to_126_updated.xlsx")
            new_widget = widget_class(equipment_name="162_to_126")
