...
training, predicts density, and returns the prediction without modifying
the input DataFrame.
"""
...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV113/density.joblib"
)


class DensityPredictor:
    """
    Predictor for Density.
    """
    ...
    def _validate_features(self, df: pd.DataFrame) -> None:
        ...
        if missing:
            raise ValueError(
                "Missing input features for Density prediction: "
                f"{missing}"
            )