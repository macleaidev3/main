...
# from src.visual_script.icv112.visual_3d import ICV112Visual3d
from ui.widgets.ribbon_tab import RibbonTab

# from visual_script.excel_visual.plot_2d_widget import Corrosion2DWidget
from src.visual_script.excel_visual.equiptment_3d_widget import Corrosion3DWidget

class CreateICE102Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            new_widget = widget_class("visual/ice102/102.xlsx")
