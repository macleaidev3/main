...
class SourWaterICV112(QtWidgets.QWidget):
    _active_threads = set()
    @classmethod
    ...
    def __init__(self, parent=None):
        ...
        self.column_names = extract_column_names(TABLE_COLUMNS["sour_water_icv112"])
    ...
    def set_up(self, year, month): # month in short format
        ...
        self.table_name = f"lab_{year}_{month}_sour_water_icv112"
    ...
    def load_data(self):
        ...
        SourWaterICV112._active_threads.add(thread)
        ...
        thread.finished.connect(lambda: SourWaterICV112._cleanup_thread(thread))
    ...
    def save(self):
        ...
        if self._data_just_loaded_from_csv: # if data is just loaded from csv
            ...
            #==================================
            is_valid, error_messages, cleaned_data = validate_and_clean_ui_data(self.loaded_data, TABLE_COLUMNS['sour_water_icv112'])
            ...
            is_valid, error_messages, cleaned_data = validate_and_clean_ui_data(
                row_list, TABLE_COLUMNS['sour_water_icv112']
            )
