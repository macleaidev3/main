...
from ml_module.pipeline_162_to_126.predict_temp import TotalTemperaturePredictor
from ml_module.pipeline_162_to_126.predict_presssure import TotalPressurePredictor
from ml_module.pipeline_162_to_126.predict_wall_shear import WallShearPredictor
from ml_module.pipeline_162_to_126.pred_cr import CorrosionRatePredictor


from src.ml_pipelines.ICE162_ICE126.input_df_builder import PredictionInputBuilder
from src.utils.core_utility_functions import sigfig, format_date_long
class CRPredictionICE162TO126():
    ...
    def __init__(self, month: str, year: str, yesterday_date: str):
        ...
        self.year = year
        self.month = month
        self.table_name = f"{year}_162_to_126_cr"
