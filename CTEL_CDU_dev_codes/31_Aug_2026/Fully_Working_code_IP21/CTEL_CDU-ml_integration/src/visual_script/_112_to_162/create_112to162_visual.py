...
# from src.visual_script._112_to_162.visual_3d import ICE112to162Visual3d
...
class Create112to162Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/_112_to_162/112-162.xlsx")
            new_widget = widget_class(equipment_name="112_to_162")
