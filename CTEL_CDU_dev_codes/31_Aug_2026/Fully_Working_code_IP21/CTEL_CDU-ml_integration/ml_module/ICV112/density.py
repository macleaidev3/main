...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/density/xgboost_density_model.pkl"
)

PREPROCESSED_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/density/preprocessed_data.pkl"
)

R2_SCALER_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/density/r2_scaler.pkl"
)
        ...
        for feature in self._interaction_features:
            ...
            if feature == "r_squared":
                ...
                if "r" not in df.columns:
                    ...
                    raise ValueError(
                        "Interaction feature r_squared requires 'r' column in input"
                    )
