...
# INPUT DIRECTORY
# =========================================================
REPORT_DIR = r"D:\Anurag BPCL WORK\Abhay Code\copy_cdu\experiments\102to161\corrosion_rate\loso_case_reports"
...
# =========================================================
plt.suptitle(
    "Error Distribution — 5 Truly Unseen Simulations (Corrosion Rate Model)",
    fontsize=22,
    fontweight='bold'
)
...
# SAVE
# =========================================================
out_path = os.path.join(REPORT_DIR, "corrosion_rate_error_distribution.png")
