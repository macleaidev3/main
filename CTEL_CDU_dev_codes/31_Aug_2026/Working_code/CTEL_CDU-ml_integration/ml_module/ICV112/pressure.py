...
MODEL_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/pressure/xgboost_pressure_model.pkl"
)

PREPROCESSED_PATH = resource_path(
    "ml_module/cache_mlmodule_1232232/ICV112/pressure/preprocessed_cdu_data.pkl"
)
