...
================================
Prediction script for trained XGBoost corrosion model.

NOTE:
------
Paste the COMPLETE engineer_features() function from the training
script where indicated below.
"""
...
MODEL_PATH = r"C:\Users\pc\Desktop\CTEL_CDU-ml_integration\CTEL_CDU_ml_integration\CTEL_CDU\CTEL_CDU\ml_module\cache_mlmodule_1232232\pipeline_161_to_112\wall_shear\model.pkl"
LEAKAGE_COLUMNS = {
    TARGET,
...
def main():
    ...
    # ------------------------------------------------------
    # Apply scaler ONLY if training used scaler
    # ------------------------------------------------------
    ...
    # ------------------------------------------------------
    # If target was trained in log space
    # Uncomment if required
    # ------------------------------------------------------

    pred = np.power(10.0, pred)
   
    df["Predicted wall_shear"] = pred
