...
FILE_NAME = "Node_162_P_2.2.xlsx_report.csv"
...
required_columns = [
    ...
    "Y[m]",
    "Z[m]",
    "predicted_CR"  ## Here "pred" is the Predicted Corrosion Rate column.
]
...
corrosion = df["predicted_CR"].to_numpy(dtype=float)
...
plotter.add_text(
    "Simple 3D Visualization of equipment 113",
    position="upper_left",
    font_size=16
)
