...
def calculate_fundus_coverage(image):
    ...
    # Pixels above this threshold are considered part of the visible fundus region.
    mask = gray > 10
...
if __name__ == "__main__":
    ...
    image_folder = (
        r"D:\Anurag BPCL WORK\Glaucosense\Evaluation of Fundus Images\my_fundus_images_results")
