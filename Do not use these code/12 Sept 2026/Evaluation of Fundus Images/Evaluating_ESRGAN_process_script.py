...
IMPORTANT:
    ...
    Other measurements such as noise increase, color change, excessive edge increase, etc. are still calculated and
    recorded, but they DO NOT independently decide whether an image is rejected.

    This is an automated image-quality evaluator. It does NOT diagnose glaucoma and does NOT claim that an image is
    clinically superior.
...
# ======================= USER SETTINGS ===========================
# ------------------------ PUT THE ORIGINAL IMAGE FOLDER HERE -------------------------------
ORIGINAL_FOLDER = r"D:\Anurag BPCL WORK\Glaucosense\Evaluation of Fundus Images\Original_images"

# ------------------------PUT THE ESRGAN IMAGE FOLDER HERE -----------------------------------
ESRGAN_FOLDER = r"D:\Anurag BPCL WORK\Glaucosense\Evaluation of Fundus Images\ESRGAN_Result"
...
def get_fundus_mask(image):
    ...
    Black background around the retina should not dominate the quality calculations.  
    """
...
def calculate_ssim(original, processed):
    ...
    1.0 = nearly identical structure lower = more structural change
    """
...
def main():
    ...
    # =========================== SAVE ESRGAN CSV =========================================
    esrgan_csv = (esrgan_folder  /  "ESRGAN_Result_evaluation.csv")
