...
# from src.visual_script._126_to_113.visual_3d import ICE126to113Visual3d
...
class Create126to113Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/_126_to_113/126-113.xlsx")
            new_widget = widget_class(equipment_name="126_to_113")
