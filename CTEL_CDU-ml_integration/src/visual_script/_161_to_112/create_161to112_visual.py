...
# from src.visual_script._161_to_112.visual_3d import ICE161to112Visual3d
...
class Create161to112Visual(RibbonTab):
    ...
    def switch_view(self, button_id: str):
        ...
        if button_id not in self.loaded_widgets:
            ...
            # new_widget = widget_class("visual/_161_to_112/161_to_112.xlsx")
            new_widget = widget_class(equipment_name="161_to_112")
