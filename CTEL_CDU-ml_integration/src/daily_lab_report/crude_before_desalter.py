...
class CrudeBeforeDesalter(QtWidgets.QWidget):
    _active_threads = set()
    @classmethod
    ...
    def __init__(self, parent=None):
        ...
        self.column_names = extract_column_names(TABLE_COLUMNS["crude_before_desalter"])
    ...
    def set_up(self, year, month): # month in short format
        ...
        self.table_name = f"lab_{year}_{month}_crude_before_desalter"
    ...
    def load_data(self):
        ...
        CrudeBeforeDesalter._active_threads.add(thread)
        ...
        thread.finished.connect(lambda: CrudeBeforeDesalter._cleanup_thread(thread))
    ...
    def save(self):
        ...
        if self._data_just_loaded_from_csv: # if data is just loaded from csv
            ...
            #==================================
            is_valid, error_messages, cleaned_data = validate_and_clean_ui_data(self.loaded_data, TABLE_COLUMNS['crude_before_desalter'])
            ...
            is_valid, error_messages, cleaned_data = validate_and_clean_ui_data(
                row_list, TABLE_COLUMNS['crude_before_desalter']
            )
